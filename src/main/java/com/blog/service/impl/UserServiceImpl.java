...
public class UserServiceImpl implements UserService {
	...
	public UserDto createUser(UserDto userDto) {
		// save karte samay user pass karenge but parameter me 'dto' ka object pass kar
		// rhe
	...
	public UserDto updateUser(UserDto userDto, Integer userId) {
		...
		// first get the user
		// user h tb us user ka detail aa jayega nhi to exception(custom) throw kar
		// dega(using lambda function).
		// exception me 3 para: kon sa resource nhi mil rha, kon sa field nhi mil rha ,
		// field ka value
	...
	public List<UserDto> getAllUsers() {
		...
		// hmko har ek user ko 'userDto' me convert karna hoga and usko return karna
		// hoga list me.
