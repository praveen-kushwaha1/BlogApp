...
public class GlobalExceptionHandler {
	...
	// ye function agar 'ResourceNotFoundException' aata h kisi bhi controller me tb
	// usko handle karega globally.
	...
	public ResponseEntity<Map<String, String>> methodArgumentNotValidExceptionHandler(
		...
		// phle erros sb niklange(list dega), then errors se field nikalenge(using
		// lambda fn) isliye hmko phle typecast karna hoga.
